ParticleEmitter("ChargeGlow")
{
	...
	Spawner()
	{
		...
		Red(0, 249.0000, 255.0000);
		Green(0, 0.0000, 19.0000);
		Blue(0, 242.0000, 255.0000);
	...
	Transformer()
	{
		...
		{
			LifeTime(0.1000)
			Reach(141.0000,14.0000,190.0000,128.0000);
			Next()
			{
				LifeTime(0.4000)
				Reach(201.0000,34.0000,215.0000,255.0000);
			}
		}
	}
	Geometry()
	...
	ParticleEmitter("Flare")
	{
		...
		Spawner()
		{
			...
			Red(0, 213.0000, 213.0000);
			Green(0, 168.0000, 168.0000);
			Blue(0, 244.0000, 244.0000);
			Alpha(0, 0.0000, 0.0000);
